...
//DAO class annotation for DAOImpl classes
@Repository
public class UserDaoImpl implements UserDao {
	...
	public boolean update(User user) throws Exception {
		ht.update(user);
		//return=true to get exception if encountered as hibernate doesn't throws exceptions
		return true;
	}
	...
	public User find(int id) throws Exception{
		//get() is used when we want a single record
